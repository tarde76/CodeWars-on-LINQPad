...
class Program
{
    static void Main(string[] args)
    {
        ...
        var longestSlideDown = PyramidSlideDown.LongestSlideDown(smallPyramid);
        Console.WriteLine($"Result for small pyramid is: {longestSlideDown}");
        longestSlideDown = PyramidSlideDown.LongestSlideDown(mediumPyramid);
        Console.WriteLine($"Result for medium pyramid is: {longestSlideDown}");
    }
}
